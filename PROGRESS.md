...
- `tests/` — 13442 pytest at HEAD (4 pre-existing flakes in test_callsign_routing/test_ad719_chat_fanout + occasional dreaming/ward_room flakes outside this wave) + 631 vitest; gate runs `-n 4 --dist=loadfile`.
