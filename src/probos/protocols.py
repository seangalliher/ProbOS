...
class NATSBusProtocol(Protocol):
    ...
    Narrow consumer-facing interface — does NOT include start/stop,
    set_subject_prefix, or ensure_stream (implementation-only).
    """
    ...
    async def remove_tracked_subscriptions(self, subjects: Iterable[str]) -> int: ...
