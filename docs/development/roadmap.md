...
- **Target:** Reduce both to ≤20 methods via extraction into focused sub-services, following the Wave 3 pattern (startup/, routers/, commands/).
...
**Build sequence:** ~~BF-089~~ ✓ ~~AD-542~~ ✓ ~~BF-090~~ ✓ ~~BF-092~~ ✓ ~~BF-091~~ ✓ → BF-093 + BF-094 (parallel, small fixes). BF-095 last (largest scope, lowest urgency).
