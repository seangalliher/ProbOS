...
| AD-733a | Real-time vision tier (fast/deep split) + 1-Hz tick batcher + LLM consumer for `vision_observation` | [#665](https://github.com/seangalliher/ProbOS/issues/665) | 4 |
| AD-733b | `ObserverAgent` type + proactive event surfacing for camera streams | [#666](https://github.com/seangalliher/ProbOS/issues/666) | 4 |
