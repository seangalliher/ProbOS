...
| AD-733c-5-4 | HXI per-agent perception badges (CameraLiveIndicator + usePerceptionEngagementStore + PerceptionLivePanel table) | (forward marker, filed Wave 176) | 4 |
