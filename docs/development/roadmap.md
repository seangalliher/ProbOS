...
Build order: Standing Orders ✅ → AD-566a ✅ → AD-566b ✅ → AD-566c ✅ → AD-566d ✅ → AD-566e ✅ → AD-567a → AD-567b (absorbs AD-462) + 567c + 567d → AD-566 re-run (measure impact) → AD-567e/f/g. Post-567: AD-566f (needs AD-423), AD-566g/h/i (independent).
