...
|---|---|---|---|
| `git log` commit subjects | pinned snapshot | 2026-09-26T12:06:50+00:00 at `7fb21407` | 2607 subjects, 1009 numbers |
...
- `AD-1243` — code is in history but [#1236](https://github.com/seangalliher/ProbOS/issues/1236) is still open.
...
```
PROGRESS.md:1169 head-shaped line yielded no AD/BF token
PROGRESS.md:1175 head-shaped line yielded no AD/BF token
