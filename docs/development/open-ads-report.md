...
|---|---|---|---|---|
| AD | **AD-1215** | **AD-1216** | AD-1211 | 1212-1215 |
| BF | **BF-725** | **BF-726** | BF-724 | 725 |

## Where each layer came from

| Authority | Availability | Captured | Extent |
|---|---|---|---|
| `git log` commit subjects | pinned snapshot | 2026-08-07T06:23:09+00:00 at `b699247d` | 2247 subjects, 822 numbers |
...
| `gh issue list --state all` | pinned snapshot (network) | 2026-08-07T06:23:09+00:00 | 1173 issues, 757 numbers |
...
| State | AD | BF | Meaning |
|---|---|---|---|
| `allocated-open` | 72 | 11 | assigned, issue open, no shipped code |
...
| `shipped` | 876 | 383 | code in history |
...
|---|---|---|---|
| `AD-1215` | [#1172](https://github.com/seangalliher/ProbOS/issues/1172) | issue #1172 open, no code | AD-1215: extension_registry is never assigned, so the install rung has never fired |
...
| `BF-725` | [#1173](https://github.com/seangalliher/ProbOS/issues/1173) | issue #1173 open, no code | BF-725: the Bridge station rows are not keyboard operable either |
...
**AD** (876): 1, 19-139, 142-153, 228, 262-273, 293-300, 302, 311, 313-314, 316-317, 321-322, 324, 348-355, 357-373, 376-388, 393-419, 423-502, 507-530, 532, 534, 538-541, 543, 550-554, 556-558, 560-577, 579-623, 625-680, 682-683, 685-692, 694-702, 704, 706-708, 710-766, 790-813, 815-828, 832-839, 841, 843, 845-847, 853-956, 958-966, 972, 975-1019, 1021-1038, 1040-1055, 1065, 1068-1089, 1091-1095, 1119-1133, 1138-1148, 1151, 1153-1155, 1157-1173, 1175-1178, 1180, 1184, 1201, 1204, 1210-1211

**BF** (383): 4, 6, 8-13, 23-25, 27, 29-37, 39-41, 43-44, 49, 53, 57-60, 63-69, 71, 76, 78-80, 82-86, 99-104, 106, 108-116, 118, 123-175, 177-179, 183-201, 203-204, 206-219, 222-326, 331-332, 597-680, 682-686, 688, 690, 692-710, 715-717, 719-724
