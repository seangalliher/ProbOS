...
| State | AD | BF | Meaning |
|---|---|---|---|
| `allocated-open` | 76 | 10 | assigned, issue open, no shipped code |
...
| `shipped` | 943 | 531 | code in history |
...
```
PROGRESS.md:1067 head-shaped line yielded no AD/BF token
PROGRESS.md:1073 head-shaped line yielded no AD/BF token
